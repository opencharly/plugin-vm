...
// Shared VM target resolution for the `spice:` check verb's HOST-side graphics-endpoint
// resolution (resolveVerbGraphics — the out-of-process candy/plugin-spice provider owns no
