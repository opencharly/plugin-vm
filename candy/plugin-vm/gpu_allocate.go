...
func requiredGPUResource(cnode *DeployNode, resources map[string]*ResolvedResource) (string, *ResolvedGpuSelector, bool) {
	if cnode == nil {
		return "", nil, false
	}
...
func autoAllocateExclusiveGPUs(spec *VmSpec, ovr *VmInstanceOverride, cnode *DeployNode, resources map[string]*ResolvedResource, domainName, backend string) (*VmInstanceOverride, error) {
